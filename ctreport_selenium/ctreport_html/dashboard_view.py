        ...
        for key in test_details.keys():
            if key == "start_time" or key == "end_time" or key == "duration" or key == "test_execution_name":
                ...
                session_details += '''
                   ...
                   '''.format(key.replace("_"," "), test_details[key])
    c='''
    <!--Dashboard-->
			...
			<div class="container-fluid">
                    ...
                    <div class="row mt-3">
						<div class="col-sm-12 col-lg-8">
							<div class="chart p-2 p-md-4 ">
								<span class="badge badge-style1 pointer" data-toggle="tooltip" data-placement="right" title="Execution timeline of each test">Timeline</span>
								<br/>
								<br/>
                        ...
                        <div class="col-sm-12 col-lg-4">
                            <div class="chart p-2 p-md-4">
								<span class="badge badge-style1 pointer"  data-toggle="tooltip" data-placement="right" title="Test execution status breakdown">Status</span>
								<!--<br/>
								<br/>-->
				...
				<section  class="pading">
                    <div class="row mt-3">
						<div class="col-sm-12 col-lg-4">
							<div class="chart p-2 p-md-4 ">
								<span class="badge badge-style1 pointer"  data-toggle="tooltip" data-placement="right" title="Test execution status breakdown on Priority of test cases">Priority</span>
								<br/>
								<br/>
                        ...
                        <div class="col-sm-12 col-lg-4">
                            <div class="chart p-2 p-md-4">
								<span class="badge badge-style1 pointer" data-toggle="tooltip" data-placement="right" title="Assertion status breakdown">Assertion</span>
								<br/>
								<br/>
						...
						<div class="col-sm-12 col-lg-4">
                            <div class="chart p-2 p-md-4">
								<span class="badge badge-style1 pointer" data-toggle="tooltip" data-placement="right" title="Verification status breakdown on Severity of verification steps">Verifications</span>
								<br/>
								<br/>
